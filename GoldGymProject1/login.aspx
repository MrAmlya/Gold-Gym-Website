<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GoldGymProject1.login" %>
            ...
            <div class="banner-bottom inner">
                ...
                <div class="container">
                    ...
                    <div class="wthree_head_section">
                        <h3 class="w3l_header w3_agileits_header">LOGIN </h3>
                    </div>
                        ...
                        <div class="contact-form agile_inner_grids">
                            ...
                            <div class="fields-grid">
                                <div class="styled-input agile-styled-input-top">
                                    <asp:TextBox ID="UserID_TextBox" required="" runat="server"></asp:TextBox>
                                    <label>UserID</label>
                                    <span></span>
                                </div>
                                <div class="styled-input agile-styled-input-top">
                                    <asp:TextBox ID="Password_TextBox" required="" runat="server"></asp:TextBox>
